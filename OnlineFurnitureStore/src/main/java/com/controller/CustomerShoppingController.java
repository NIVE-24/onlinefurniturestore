...
public class CustomerShoppingController {
	...
	private CustomerShoppingService onlineFurnitureStoreService;
	...
	public String placeOrder(@RequestBody Order furnitureorder) throws CustomerShoppingException {
		Order furniture1 = onlineFurnitureStoreService.placeOrder(furnitureorder);
